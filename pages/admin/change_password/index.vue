    <template>
        ...
        <section class="content">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-outline-info mr-1 btn-submit" type="submit">
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/admin/change_password/${this.$auth.user.user.id}`)
      .then((response) => {
        //data yang diambil
  ...
  methods: {
    ...
    async update(e) {
      ...
      if (this.field.new_password === this.field.confirm_password) {
        // console.log(this.$auth.user.user.password)
        await this.$axios
          .put(`/api/admin/change_password/${this.$auth.user.user.id}`, {
            //data yang dikirim
