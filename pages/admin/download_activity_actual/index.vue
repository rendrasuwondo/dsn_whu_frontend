...
export default {
  ...
  methods: {
    ...
    exportData2() {
      ...
      this.$axios({
        url: `/api/admin/download_activity_actual/export?q=${this.search}&activitied_at_prepend=${this.activitied_at_start}&activitied_at_append=${this.activitied_at_end}`,
        method: 'GET',
        responseType: 'blob',
        headers: headers, // important
      }).then((response) => {
